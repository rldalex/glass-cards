...
`;var yt=Object.defineProperty,$t=(t,e,s,i)=>{for(var n,r=void 0,a=t.length-1;a>=0;a--)(n=t[a])&&(r=n(e,s,r)||r);return r&&yt(e,s,r),r};class xt extends ft{constructor(){super(...arguments),this._expandedEntity=null}static{this.styles=[bt,mt,_t,o`
      :host {
        display: block;
    ...
    `]}setConfig(t){super.setConfig(t)}getCardSize(){return 3}getTrackedEntityIds(){return this._getLights().map(t=>t.entity_id)}updated(t){super.updated(t);this._getLights().some(t=>"on"===t.state)?this.setAttribute("lights-on",""):this.removeAttribute("lights-on")}_getLights(){if(!this.hass)return[];if(this.areaId)return vt(this.areaId,this.hass.entities,this.hass.devices).filter(t=>t.entity_id.startsWith("light.")).map(t=>this.hass?.states[t.entity_id]).filter(t=>void 0!==t);if(this._config?.entity){const t=this.hass.states[this._config.entity];return t?[t]:[]}return[]}_toggleLight(t){this.hass?.callService("light","toggle",{},{entity_id:t})}_toggleAll(){const t=this._getLights(),e=t.some(t=>"on"===t.state)?"turn_off":"turn_on",s=t.map(t=>t.entity_id);this.hass?.callService("light",e,{},{entity_id:s})}_setBrightness(t,e){this.hass?.callService("light","turn_on",{brightness_pct:e},{entity_id:t})}_toggleExpand(t){this._expandedEntity=this._expandedEntity===t?null:t}_getBrightnessPct(t){const e=t.attributes.brightness;return void 0===e?0:Math.round(e/255*100)}_renderLightRow(t){const e="on"===t.state,s=t.attributes.friendly_name||t.entity_id,i=e?this._getBrightnessPct(t):0,n=this._expandedEntity===t.entity_id;return q`
      <div class="light-row">
        ...
        <button
          ...
          ${e?q`aria-expanded=${n?"true":"false"}`:V}
        >
    ...
    `]}connectedCallback(){super.connectedCallback(),this._busCleanups.push(t.on("popup-open",t=>this._handleOpen(t)),t.on("popup-close",()=>this._handleClose())),document.addEventListener("keydown",this._boundKeydown)}disconnectedCallback(){super.disconnectedCallback(),void 0!==this._pendingRaf&&(cancelAnimationFrame(this._pendingRaf),this._pendingRaf=void 0),this._busCleanups.forEach(t=>t()),this._busCleanups=[],document.removeEventListener("keydown",this._boundKeydown)}_handleOpen(t){this._areaId=t.areaId,this._scenesOpen=!1,this._pendingRaf=requestAnimationFrame(()=>{this._pendingRaf=void 0,this._open=!0,this.setAttribute("open","")})}_handleClose(){void 0!==this._pendingRaf&&(cancelAnimationFrame(this._pendingRaf),this._pendingRaf=void 0),this._open=!1,this.removeAttribute("open"),setTimeout(()=>{this._areaId=null},350)}_onKeydown(e){"Escape"===e.key&&this._open&&t.emit("popup-close",void 0)}_onOverlayClick(){t.emit("popup-close",void 0)}_getAreaMeta(){if(!this.hass||!this._areaId)return null;const t=this.hass.areas[this._areaId];if(!t)return null;const e=vt(this._areaId,this.hass.entities,this.hass.devices);let s=null,i=null;const n=[],r=new Set;for(const a of e){const t=this.hass?.states[a.entity_id];if(!t)continue;const e=a.entity_id.split(".")[0];if(r.add(e),"sensor"===e){const e=t.attributes.device_class;"temperature"!==e||s||(s=`${t.state}${t.attributes.unit_of_measurement||"°C"}`),"humidity"!==e||i||(i=`${t.state}%`)}"scene"===e&&n.push(t)}return{name:t.name,icon:t.icon||"mdi:home",temperature:s,humidity:i,scenes:n,domains:[...r]}}_activateScene(t){this.hass?.callService("scene","turn_on",{},{entity_id:t})}_hasDomain(t,e){return t.includes(e)}render(){if(!this._areaId)return V;const e=this._getAreaMeta();return e?q`
