      ...
      <div class="title-card">
        ...
        ${i?K`
          ...
          >
            <div
              class="dash-line"
              style="${r?`background:${a.dot};box-shadow:0 0 8px ${a.glow};width:24px`:""}"
            ></div>
          </button>
