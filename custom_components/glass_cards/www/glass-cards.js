          ...
          <div class="person-sub">
            ...
            <div class="person-line">
              ${null!=e.batteryLevel?K`
                    <span class="person-battery ${a=e.batteryLevel,a>50?"high":a>20?"medium":"low"}">
              ...
              <span class="person-last-seen">${function(e){const t=Math.floor((Date.now()-new Date(e).getTime())/1e3);return t<60?Re("presence.just_now"):t<3600?Re("presence.min_ago",{count:Math.floor(t/60)}):t<86400?Re("presence.hours_ago",{count:Math.floor(t/3600)}):Re("presence.days_ago",{count:Math.floor(t/86400)})}(e.lastUpdated)}</span>
            </div>
          </div>
        </div>
      </div>
    `;var a,r}_renderDistance(e,t){if(null==e.latitude||null==e.longitude||null==t.latitude||null==t.longitude)return Y;const i=function(e,t,i,s){const a=(i-e)*Math.PI/180,r=(s-t)*Math.PI/180,o=Math.sin(a/2)**2+Math.cos(e*Math.PI/180)*Math.cos(i*Math.PI/180)*Math.sin(r/2)**2;return 12742*Math.atan2(Math.sqrt(o),Math.sqrt(1-o))}(e.latitude,e.longitude,t.latitude,t.longitude),s=i<.05,a=String(i<1?Math.round(1e3*i):Math.round(i)),r=Re(i<1?"presence.distance_m":"presence.distance_km");return K`
