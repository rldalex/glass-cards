              ...
              ${e.duration>0&&Ui(e,2)?K`
                <div class="dash-progress-wrap">
                  <div class="dash-time-row">
                    <span class="dash-track-time">${Ni(s)}</span>
                    <span class="dash-track-time">${Ni(e.duration)}</span>
                  </div>
