      ...
      `:U`
        ...
        ${[...n.entries()].map(([t,i])=>U`
          <div class="section-label" style="margin-top:16px;display:flex;align-items:center;">
            <ha-icon .icon=${function(e){return Me[e]??"mdi:help-circle"}(t)} style="--mdc-icon-size:16px;display:flex;align-items:center;justify-content:center;margin-right:6px;"></ha-icon>
          ...
          <div class="pw-forecast-zone">
            ...
            ${e._weatherShowDaily?U`
              <div class="pw-daily-list">
                ${["mdi:weather-sunny","mdi:weather-partly-cloudy","mdi:weather-cloudy","mdi:weather-rainy","mdi:weather-partly-cloudy","mdi:weather-sunny","mdi:weather-cloudy"].slice(0,5).map((e,t)=>{const i=(H+t)%7,a=0===t?Ce("weather.today"):O[i],o=Math.round(T[t]),r=Math.round(z[t]),n=M[t];return U`
