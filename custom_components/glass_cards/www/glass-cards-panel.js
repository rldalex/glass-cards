        ...
        <div class="pw-content">
          <div class="pw-header">
            ...
            <div class="pw-header-right">
              ...
              ${null!=_?V`<span class="pw-feels">${ye("weather.feels_like",{temp:String(Math.round(_))})}</span>`:q}
            </div>
          </div>
          ...
          <div class="pw-spark-zone">
            ...
            <div class="pw-spark-labels">
              ${P.map((e,t)=>t%2==0||t===P.length-1?V`<span class="pw-spark-lbl" style="left: ${t/(P.length-1)*100}%;">${e}</span>`:q)}
            </div>
          </div>
            ...
            <div class="pw-forecast-zone">
              ...
              ${this._weatherShowDaily?V`
                <div class="pw-daily-list">
                  ${["mdi:weather-sunny","mdi:weather-partly-cloudy","mdi:weather-cloudy","mdi:weather-rainy","mdi:weather-partly-cloudy","mdi:weather-sunny","mdi:weather-cloudy"].slice(0,5).map((e,t)=>{const i=(R+t)%7,o=0===t?ye("weather.today"):I[i],a=Math.round(z[t]),s=Math.round(A[t]),r=O[t];return V`
