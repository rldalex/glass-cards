            ...
            <div class="pw-forecast-zone">
              ...
              ${this._weatherShowDaily?U`
                <div class="pw-daily-list">
                  ${["mdi:weather-sunny","mdi:weather-partly-cloudy","mdi:weather-cloudy","mdi:weather-rainy","mdi:weather-partly-cloudy","mdi:weather-sunny","mdi:weather-cloudy"].slice(0,5).map((e,t)=>{const i=(H+t)%7,a=0===t?we("weather.today"):z[i],s=Math.round(T[t]),r=Math.round(O[t]),o=A[t];return U`
