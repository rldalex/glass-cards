        ...
        <div class="pw-content">
          ...
          <div class="pw-spark-zone">
            ...
            <div class="pw-spark-labels">
              ${M.map((e,t)=>t%2==0||t===M.length-1?U`<span class="pw-spark-lbl" style="left: ${t/(M.length-1)*100}%;">${e}</span>`:W)}
            </div>
          </div>
