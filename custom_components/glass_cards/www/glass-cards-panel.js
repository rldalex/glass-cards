      ...
      <div class="pw-content">
        <div class="pw-header">
          ...
          <div class="pw-header-right">
            ...
            ${null!=m?q`<span class="pw-feels">${Ee("weather.feels_like",{temp:String(Math.round(m))})}</span>`:F}
          </div>
        </div>
