      ...
      <div class="mp-content">
        ...
        <div class="mp-top">
          <div class="mp-pill">
            ...
            <span>${t?e._rooms.find(e=>e.areaId===t)?.name??"Room":"Salon"}</span>
            ${a>0?q`
              <div class="mp-eq">
        ...
        <div class="dropdown ${e._mediaAddDropdownOpen?"open":""}">
          ...
          <div class="dropdown-menu" role="listbox">
            <input
              ...
              @input=${t=>{e._mediaEntitySearch=t.target.value,e.requestUpdate()}}
              @click=${e=>e.stopPropagation()}
            />
          ...
          <div class="pw-forecast-zone">
            ...
            ${e._weatherShowDaily?q`
              <div class="pw-daily-list">
                ${["mdi:weather-sunny","mdi:weather-partly-cloudy","mdi:weather-cloudy","mdi:weather-rainy","mdi:weather-partly-cloudy","mdi:weather-sunny","mdi:weather-cloudy"].slice(0,5).map((e,t)=>{const i=(H+t)%7,a=0===t?Ee("weather.today"):R[i],o=Math.round(M[t]),r=Math.round(T[t]),s=z[t];return q`
