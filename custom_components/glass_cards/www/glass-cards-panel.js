...
automation:
  ...
  `}(t)}function ct(e,t){e._climateRoom=t,e._climateRoomDropdownOpen=!1,e._loadRoomClimates()}function dt(e,t){e._climateRoomEntities=e._climateRoomEntities.map(e=>e.entityId===t?{...e,visible:!e.visible}:e)}function lt(e,t,i){const a=t+i;if(a<0||a>=e._climateRoomEntities.length)return;const r=[...e._climateRoomEntities];[r[t],r[a]]=[r[a],r[t]],e._climateRoomEntities=r}function pt(e,t,i){i.preventDefault();const a=Number(i.dataTransfer?.getData("text/plain"));if(isNaN(a)||a===t)return;const r=[...e._climateRoomEntities],[o]=r.splice(a,1);r.splice(t,0,o),e._climateRoomEntities=r}const ht=["light","cover","climate","fan","media_player","camera"];function _t(e){if(!e.hass)return B;const t=e._unassignedEntities,i=Object.values(e.hass.areas).sort((e,t)=>e.name.localeCompare(t.name)),a=e._unassignedEntitySearch.toLowerCase(),r=e._unassignedAreaSearch.toLowerCase(),o=a?t.filter(e=>e.name.toLowerCase().includes(a)||e.entityId.toLowerCase().includes(a)):t,n=new Map;for(const d of o){const e=n.get(d.domain)??[];e.push(d),n.set(d.domain,e)}const s=t.filter(e=>!e.areaId).length,c=r?i.filter(e=>e.name.toLowerCase().includes(r)):i;return U`
          ...
          <div class="pw-forecast-zone">
            ...
            ${e._weatherShowDaily?U`
              <div class="pw-daily-list">
                ${["mdi:weather-sunny","mdi:weather-partly-cloudy","mdi:weather-cloudy","mdi:weather-rainy","mdi:weather-partly-cloudy","mdi:weather-sunny","mdi:weather-cloudy"].slice(0,5).map((e,t)=>{const i=(H+t)%7,a=0===t?De("weather.today"):R[i],r=Math.round(O[t]),o=Math.round(M[t]),n=T[t];return U`
          ...
          ${a.map((t,i)=>U`
            <div class="item-row" draggable="true"
              ...
              <div style="display:flex;align-items:center;gap:4px;">
                <button class="btn-icon xs" @click=${()=>lt(e,i,-1)}
                ...
                <button class="btn-icon xs" @click=${()=>dt(e,t.entityId)}
                  aria-label="${t.visible?De("common.hide"):De("common.show")} ${t.name}">
  ...
  `}(this)}_renderTitlePreview2(){return rt(this)}_renderTitleTab(){return ot(this)}_renderUnassignedPreview(){return B}_renderUnassignedTab(){return _t(this)}static{this._TAB_META=[{id:"dashboard",icon:"mdi:view-dashboard",labelKey:"config.tab_dashboard"},{id:"title",icon:"mdi:format-title",labelKey:"config.tab_title"},{id:"navbar",icon:"mdi:dock-bottom",labelKey:"config.tab_navbar"},{id:"popup",icon:"mdi:card-outline",labelKey:"config.tab_popup"},{id:"light",icon:"mdi:lightbulb-group",labelKey:"config.tab_light"},{id:"weather",icon:"mdi:weather-partly-cloudy",labelKey:"config.tab_weather"},{id:"media",icon:"mdi:speaker",labelKey:"config.tab_media"},{id:"cover",icon:"mdi:blinds",labelKey:"config.tab_cover"},{id:"climate",icon:"mdi:thermostat",labelKey:"config.tab_climate"},{id:"fan",icon:"mdi:fan",labelKey:"config.tab_fan"},{id:"spotify",icon:"mdi:spotify",labelKey:"config.tab_spotify"},{id:"presence",icon:"mdi:account-group",labelKey:"config.tab_presence"},{id:"camera_carousel",icon:"mdi:cctv",labelKey:"config.tab_camera_carousel"},{id:"unassigned",icon:"mdi:home-map-marker",labelKey:"config.tab_unassigned"}]}_renderTabSelect(){const t=e._TAB_META.find(e=>e.id===this._tab),i=this._tabSearch.toLowerCase();return U`
    ...
    `:B}};kt([he({attribute:!1})],St.prototype,"hass"),kt([he({type:Boolean})],St.prototype,"narrow"),kt([_e()],St.prototype,"_lang"),kt([_e()],St.prototype,"_tab"),kt([_e()],St.prototype,"_tabSelectOpen"),kt([_e()],St.prototype,"_tabSearch"),kt([_e()],St.prototype,"_rooms"),kt([_e()],St.prototype,"_emptyRooms"),kt([_e()],St.prototype,"_selectedRoom"),kt([_e()],St.prototype,"_cards"),kt([_e()],St.prototype,"_scenes"),kt([_e()],St.prototype,"_lights"),kt([_e()],St.prototype,"_lightRoom"),kt([_e()],St.prototype,"_lightDropdownOpen"),kt([_e()],St.prototype,"_iconPickerRoom"),kt([_e()],St.prototype,"_dropdownOpen"),kt([_e()],St.prototype,"_toast"),kt([_e()],St.prototype,"_saving"),kt([_e()],St.prototype,"_showLights"),kt([_e()],St.prototype,"_showTemperature"),kt([_e()],St.prototype,"_showHumidity"),kt([_e()],St.prototype,"_showMedia"),kt([_e()],St.prototype,"_autoSort"),kt([_e()],St.prototype,"_tempHigh"),kt([_e()],St.prototype,"_tempLow"),kt([_e()],St.prototype,"_humidityThreshold"),kt([_e()],St.prototype,"_weatherEntity"),kt([_e()],St.prototype,"_weatherHiddenMetrics"),kt([_e()],St.prototype,"_weatherShowDaily"),kt([_e()],St.prototype,"_weatherShowHourly"),kt([_e()],St.prototype,"_weatherShowHeader"),kt([_e()],St.prototype,"_weatherDropdownOpen"),kt([_e()],St.prototype,"_titleText"),kt([_e()],St.prototype,"_titleSources"),kt([_e()],St.prototype,"_titlePeriodEntity"),kt([_e()],St.prototype,"_titlePeriodOptions"),kt([_e()],St.prototype,"_titleEditingSourceIdx"),kt([_e()],St.prototype,"_titleAddSourceDropdownOpen"),kt([_e()],St.prototype,"_titleAddEntityDropdownOpen"),kt([_e()],St.prototype,"_iconPopupModeIdx"),kt([_e()],St.prototype,"_iconSearch"),kt([_e()],St.prototype,"_lightShowHeader"),kt([_e()],St.prototype,"_coverShowHeader"),kt([_e()],St.prototype,"_coverDashboardCompact"),kt([_e()],St.prototype,"_coverDashboardEntities"),kt([_e()],St.prototype,"_coverDashboardOrder"),kt([_e()],St.prototype,"_coverPresets"),kt([_e()],St.prototype,"_coverEntityPresets"),kt([_e()],St.prototype,"_coverRoom"),kt([_e()],St.prototype,"_coverRoomDropdownOpen"),kt([_e()],St.prototype,"_coverRoomEntities"),kt([_e()],St.prototype,"_coverPresetInput"),kt([_e()],St.prototype,"_coverEntityPresetInput"),kt([_e()],St.prototype,"_coverPresetsExpandedEntity"),kt([_e()],St.prototype,"_fanShowHeader"),kt([_e()],St.prototype,"_fanRoom"),kt([_e()],St.prototype,"_fanRoomDropdownOpen"),kt([_e()],St.prototype,"_fanRoomEntities"),kt([_e()],St.prototype,"_climateShowHeader"),kt([_e()],St.prototype,"_climateDisplayMode"),kt([_e()],St.prototype,"_climateDashboardDisplayMode"),kt([_e()],St.prototype,"_climateDashboardEntities"),kt([_e()],St.prototype,"_climateRoom"),kt([_e()],St.prototype,"_climateRoomDropdownOpen"),kt([_e()],St.prototype,"_climateRoomEntities"),kt([_e()],St.prototype,"_presenceShowHeader"),kt([_e()],St.prototype,"_presencePersonEntities"),kt([_e()],St.prototype,"_presenceSmartphoneSensors"),kt([_e()],St.prototype,"_presenceNotifyServices"),kt([_e()],St.prototype,"_presenceDrivingSensors"),kt([_e()],St.prototype,"_presenceDropdownOpen"),kt([_e()],St.prototype,"_presenceDropdownSearch"),kt([_e()],St.prototype,"_mediaShowHeader"),kt([_e()],St.prototype,"_mediaExtraEntities"),kt([_e()],St.prototype,"_mediaRoom"),kt([_e()],St.prototype,"_mediaRoomDropdownOpen"),kt([_e()],St.prototype,"_mediaRoomNativePlayers"),kt([_e()],St.prototype,"_mediaAddDropdownOpen"),kt([_e()],St.prototype,"_mediaEntitySearch"),kt([_e()],St.prototype,"_spotifyShowHeader"),kt([_e()],St.prototype,"_spotifyEntity"),kt([_e()],St.prototype,"_spotifySortOrder"),kt([_e()],St.prototype,"_spotifyDropdownOpen"),kt([_e()],St.prototype,"_spotifyMaxItems"),kt([_e()],St.prototype,"_spotifyVisibleSpeakers"),kt([_e()],St.prototype,"_spotifyConfigured"),kt([_e()],St.prototype,"_cameraShowHeader"),kt([_e()],St.prototype,"_cameraAutoCycle"),kt([_e()],St.prototype,"_cameraCycleInterval"),kt([_e()],St.prototype,"_cameraEntityOrder"),kt([_e()],St.prototype,"_unassignedEntities"),kt([_e()],St.prototype,"_unassignedDropdownEntity"),kt([_e()],St.prototype,"_unassignedEntitySearch"),kt([_e()],St.prototype,"_unassignedAreaSearch"),kt([_e()],St.prototype,"_unassignedEditingEntity"),kt([_e()],St.prototype,"_dashboardEnabledCards"),kt([_e()],St.prototype,"_dashboardCardOrder"),kt([_e()],St.prototype,"_dashboardHideHeader"),kt([_e()],St.prototype,"_dashboardHideSidebar"),kt([_e()],St.prototype,"_dashboardExpanded"),kt([_e()],St.prototype,"_scheduleExpandedEntity"),kt([_e()],St.prototype,"_pickerOpen"),kt([_e()],St.prototype,"_pickerYear"),kt([_e()],St.prototype,"_pickerMonth"),kt([_e()],St.prototype,"_pickerStartDay"),kt([_e()],St.prototype,"_pickerStartMonth"),kt([_e()],St.prototype,"_pickerStartYear"),kt([_e()],St.prototype,"_pickerEndDay"),kt([_e()],St.prototype,"_pickerEndMonth"),kt([_e()],St.prototype,"_pickerEndYear"),kt([_e()],St.prototype,"_pickerStartHour"),kt([_e()],St.prototype,"_pickerStartMinute"),kt([_e()],St.prototype,"_pickerEndHour"),kt([_e()],St.prototype,"_pickerEndMinute"),kt([_e()],St.prototype,"_pickerPhase"),kt([_e()],St.prototype,"_dragIdx"),kt([_e()],St.prototype,"_dropIdx"),kt([_e()],St.prototype,"_dragContext"),kt([_e()],St.prototype,"_dragModeSrcIdx"),kt([_e()],St.prototype,"_toastError");let Et=St;try{customElements.define("glass-config-panel",Et)}catch{}}();
