          ...
          <div class="pw-forecast-zone">
            ...
            ${e._weatherShowDaily?q`
              <div class="pw-daily-list">
                ${["mdi:weather-sunny","mdi:weather-partly-cloudy","mdi:weather-cloudy","mdi:weather-rainy","mdi:weather-partly-cloudy","mdi:weather-sunny","mdi:weather-cloudy"].slice(0,5).map((e,t)=>{const i=(H+t)%7,a=0===t?Ee("weather.today"):T[i],o=Math.round(M[t]),r=Math.round(z[t]),s=R[t];return q`
