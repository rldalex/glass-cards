          ...
          <div class="item-list empty-rooms">
            ${this._emptyRooms.map(t=>B`
              <div class="item-row disabled">
                ...
                <div class="room-icon-btn" style="pointer-events:none;opacity:0.4">
                  <ha-icon .icon=${t.icon}></ha-icon>
                </div>
                <div class="item-info">
