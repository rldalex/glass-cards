      ...
      <div class="pw-content">
        ...
        <div class="pw-spark-zone">
          ...
          <div class="pw-spark-labels">
            ${I.map((e,t)=>t%2==0||t===I.length-1?W`<span class="pw-spark-lbl" style="left: ${t/(I.length-1)*100}%;">${e}</span>`:B)}
          </div>
        </div>
