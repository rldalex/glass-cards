  ...
  `}function He(e){const t=e._coverRoomEntities.filter(e=>e.visible),i=t.filter(t=>{const i=e.hass?.states[t.entityId];return"open"===i?.state||"opening"===i?.state}).length;return U`
    <div class="preview-cover">
      ...
      <div class="preview-cover-card glass" style="padding:8px 10px;display:grid;grid-template-columns:1fr 1fr;gap:0;position:relative;">
        ...
        `:F}
        ${function(e,t){const i=[];let a=0;for(;a<t.length;){const o=t[a];"compact"===o.layout&&a+1<t.length&&"compact"===t[a+1].layout?(i.push(Me(e,o,!0,!1)),i.push(Me(e,t[a+1],!0,!0)),a+=2):(i.push(Me(e,o,!1,!1)),a++)}return i}(e,t.slice(0,4))}
        ${t.length>4?U`
          ...
          <div class="pw-forecast-zone">
            ...
            ${e._weatherShowDaily?U`
              <div class="pw-daily-list">
                ${["mdi:weather-sunny","mdi:weather-partly-cloudy","mdi:weather-cloudy","mdi:weather-rainy","mdi:weather-partly-cloudy","mdi:weather-sunny","mdi:weather-cloudy"].slice(0,5).map((e,t)=>{const i=(H+t)%7,a=0===t?$e("weather.today"):O[i],o=Math.round(T[t]),r=Math.round(z[t]),s=M[t];return U`
