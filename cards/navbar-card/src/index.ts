...
const DEFAULT_CARD_ORDER = ['title', 'weather', 'climate', 'light', 'media', 'fan', 'cover', 'spotify', 'presence', 'camera_carousel', 'calendar'];
...
export class GlassNavbarCard extends BaseCard {
  ...
  private _getOrCreateCard(tag: string): HTMLElement {
    ...
    if (tag === 'glass-light-card' || tag === 'glass-fan-card' || tag === 'glass-climate-card') {
