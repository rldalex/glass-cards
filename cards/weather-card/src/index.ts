import { html, svg, nothing, type CSSResult, type TemplateResult, type PropertyValues } from 'lit';
...
class GlassWeatherCard extends BaseCard {
  ...
  static styles: CSSResult[] = [glassTokens, hostMixin, glassMixin, foldMixin, bounceMixin, weatherCardStyles];
