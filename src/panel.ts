/**
 * Entry point for the Glass Cards config panel (sidebar page).
 * HA loads this as a JS module and renders <glass-config-panel>.
 */
import '../cards/config-panel/src/index';

// Card imports for live preview in config panel tabs
